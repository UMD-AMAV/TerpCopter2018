function test_copy2(h,sTrainerBox)
...
% ax = h;
% set (gcf, 'WindowButtonDownFcn', {@wbdcb,pax1,ax,sTrainerBox},'units','normalized');
% 
%       function wbdcb(src,evnt,pax1,ax,sTrainerBox)
...
%                 drawnow
%                 set(src,'WindowButtonMotionFcn',{@wbmcb,pax1,ax,sTrainerBox})
%                
%           end
...
%                 % callback
%                 trim_scaled(1:4) = inf;
%                 send_stick_cmd(u_stick_cmd,trim_scaled, sTrainerBox);
%       end
%    
%       
%       function wbmcb(src,evnt,pax1,ax,sTrainerBox)
