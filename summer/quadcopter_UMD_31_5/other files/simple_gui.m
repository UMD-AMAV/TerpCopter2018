...
% Last Modified by GUIDE v2.5 27-May-2018 20:26:09
disp('code started');
...
pos = handles.slider1.Position;
pos3= handles.uipanel1.Position;
pos4 = handles.axes1.Position;
% 
%  l = pos(3); h = pos(4)/5;
%  pos1 = [(pos(1)+l), (pos(2)+pos(4)/2-h/2),l,h];
%  pos2 = [110, 10, 50,50];
% % l = pos(3); h = pos(4);
% % pos1 = [(pos(1)+(pos(3)-l)/2), (pos(2)-h),l,h];
%   b1 = uicontrol('Parent',handles.slider1.Parent,'Style','text','Units','characters','Position',...
%        pos1,'String','__','BackgroundColor',handles.slider1.Parent.Color);
...
l = pos(3); h = pos(4)/5;
pos1 = [(pos(1)+l), (pos(2)+pos(4)/2-h/2),l,h];
uicontrol('Parent',hObject.Parent,'Style','text','Units','characters','Position',...
pos1,'String','__','BackgroundColor',hObject.Parent.Color);
...
% javacomponent(jSlider,[40,40,300,20],hObject);
% set(jSlider, 'MajorTickSpacing',1, 'PaintTicks', true, 'PaintLabels', true);
...
pos1 = [(pos(1)+(pos(3)-l)/2), (pos(2)-h),l,h];
% l = pos(3); h = pos(4)/10;
%  pos = [(pos(1)+l), (pos(2)+(pos(4)-h)/2),l,h];
%  hObject.Parent.Color
% 
b1 = uicontrol('Parent',hObject.Parent,'Style','text','Units','characters','Position',...
       pos1,'String','|','BackgroundColor',hObject.Parent.Color);
...
% handles    structure with handles and user data (see GUIDATA)
% disp(hObject);
 hObject.Value = handles.slider3.Value;
hObject.String = num2str(uint8(hObject.Value));
...
% handles    empty - handles not created until after all CreateFcns called
disp(hObject);
% hObject.String = num2str(handles.slider3.Value);
disp('text2');