...
u_stick_cmd(1) = 0; % thrust %%% WARNING; CHANGE TO -1
...
set(handles.k_h_d_textbox,'String',num2str(gains(3)));
set(handles.k_si_editTextBox,'String',num2str(gains(4)));
...
set(handles.kph_slider, 'SliderStep', [(.1)  (.1) ]);
set(handles.kph_slider, 'SliderStep', [.05  .05 ]);
set(handles.kph_slider, 'SliderStep', [.05  0.05 ]);
...
global imu_yawsub t_c lidarsub;
