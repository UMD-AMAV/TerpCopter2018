...
% Last Modified by GUIDE v2.5 28-Jun-2018 13:33:50
...
if isempty(currentMissionList) == 1
    ...
    %set(handles.StackTable, 'ColumnWidth',  200)
else
...
missionStackCellArray = push(missionStackCellArray, missionState, SelectedBehavior)
setappdata(handles.CreateNewMissionButton, 'missionStackCellArray', missionStackCellArray)

%Updates/Stores the Behavior Name into the UITABLE in GUI
missionStackTable = push(missionStackTable, missionState, behaviorName)
set(handles.StackTable, 'Data', missionStackTable)
...
if isempty(missionStackCellArray)
    ...
    if SelectedBehavior == 0
        ...
        set(handles.CellKheightStaticText, 'String', K_h)
        %set(handles.heightdesiredEdit, 'String'))
